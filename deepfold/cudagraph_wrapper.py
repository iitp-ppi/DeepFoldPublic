...
class CudaGraphFunctionWrapper:
    ...
    class CudaGraphWrapperModule(nn.Module):
        ...
        def __init__(self, context, module, params_modules: list) -> None:
    ...
    def _cudagraph_run(self, graph):
        if isinstance(graph, torch.cuda.graphs.CUDAGraph):
            ...
            (out_args, _) = self.out_wrapper.pack(outputs, self.out_wrapper.literature, self.out_wrapper.nnModule)
            return out_args
