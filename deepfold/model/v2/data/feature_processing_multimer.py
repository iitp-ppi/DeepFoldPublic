...
from deepfold.model.v2.data import msa_pairing
...
def process_final(np_example: Mapping[str, np.ndarray]) -> Mapping[str, np.ndarray]:
...
def _filter_features(np_example: Mapping[str, np.ndarray]) -> Mapping[str, np.ndarray]:
