...
from deepfold.model.v2.modules.input import data_ops, data_ops_multimer
...
def nonensembled_transform_fns():
    ...
    transforms = [
        ...
        data_ops_multimer.make_msa_profile,
        data_ops_multimer.create_target_feat,
        data_ops.make_atom14_masks,
    ]
...
def ensembled_transform_fns(common_cfg: DictConfig, mode_cfg: DictConfig, ensemble_seed: int):
    ...
    transforms.append(data_ops_multimer.sample_msa(max_msa_clusters, max_extra_msa, seed=msa_seed))
    ...
    if "masked_msa" in common_cfg:
        ...
        transforms.append(
            data_ops_multimer.make_masked_msa(
    ...
    if mode_cfg.fixed_size:
        ...
        if mode_cfg.crop:
            transforms.append(
                data_ops_multimer.random_crop_to_size(
